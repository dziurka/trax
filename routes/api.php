...
use App\Http\API\Trips\Controllers\CarController;
use App\Http\API\Trips\Controllers\TripController;
...
//Mock endpoint to get all cars for the logged in user todo: delete
